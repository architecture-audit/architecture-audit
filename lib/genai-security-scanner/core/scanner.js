...
const AdversarialInputsDetector = require('../detectors/adversarial-inputs');
const OutputManipulationDetector = require('../detectors/output-manipulation');
...
class ScannerCore {
    constructor(config) {
        ...
        this.detectors = {
            ...
            biasDetection: new BiasDetector(detectorConfig), // Alias for compatibility
            ...
            adversarialInputs: new AdversarialInputsDetector(detectorConfig),
            outputManipulation: new OutputManipulationDetector(detectorConfig)
        };
