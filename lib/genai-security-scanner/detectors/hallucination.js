...
class HallucinationDetector {
    constructor(config) {
        ...
        // Initialize hallucination helpers
        this.helpers = new HallucinationHelpers();
    ...
    async testFactualAccuracy() {
        ...
        results.informationDivergence = this.helpers.calculateInformationDivergence(results.responses);
    ...
    analyzeResponseInformation(response, expectedAnswer, question) {
        try {
            ...
            const pmiScores = this.helpers.calculatePMIScores(responseTokens, answerTokens, questionTokens);
            ...
            return {
                ...
                pmiScores,
                informationGain: this.helpers.calculateInformationGain ?
                    this.helpers.calculateInformationGain(responseTokens, answerTokens) : 0
            };
        } catch (error) {
